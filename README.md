...
Держит соединение с online clientами по вебсокету. Nginx шлет о состоянии пользователя Heartbit с определенным интервалом в Client Status. В Zookeeper хранится map id пользователя с connection по вебсокету, достигается за счет балансировщика Sticky sessions.
<br>
БД: Zookeeper.
<br>
